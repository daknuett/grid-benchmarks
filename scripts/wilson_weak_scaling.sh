...
#MPILIST="32.4.1.1  16.8.1.1  16.4.2.1  16.2.2.2  8.8.2.1  8.4.4.1  8.4.2.2  4.4.4.2"
...
GRID=128.128.64.64
MPILIST=$( python3 generate-mpilist.py $N $GRID )
#MPILIST="32.2.1.1  16.4.1.1  8.8.1.1  8.4.2.1  4.4.4.1  4.4.2.2"
...
GRID=128.64.64.64
MPILIST=$( python3 generate-mpilist.py $N $GRID )
#MPILIST="32.1.1.1  16.2.1.1  8.4.1.1  8.2.2.1  4.4.2.1  4.2.2.2"
...
GRID=64.64.64.64
MPILIST=$( python3 generate-mpilist.py $N $GRID )
#MPILIST="16.1.1.1  8.2.1.1  4.4.1.1  4.2.2.1  2.2.2.2"
